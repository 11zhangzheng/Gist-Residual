...
| E01 | Dataset/manifests | Video-MME-v2 `PARTIAL_DATASET_PILOT` (45 videos/180 questions) | no | E00 | environment | manifests + selections + Source Gate | data protocol | WIRED; BLOCKED: verified metadata/raw videos/human audit |
...
| E03 | Production Canary | 16 real Video-MME-v2 pilot questions | yes | E02 | Authority | canonical provider JSONL/observations/cost/validation | gate only | CONTRACT WIRED; BLOCKED: frozen Transformers backend/request manifest |
...
| E13 | Main benchmarks | LongVideoBench, LVBench, MLVU; 3 seeds | yes | E11 | BC/leakage/label | predictions/cost/Pareto | main C1 | BLOCKED |
